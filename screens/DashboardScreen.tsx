...
const sh = StyleSheet.create({
  row:     { flexDirection:"row", justifyContent:"space-between", alignItems:"center", paddingVertical:10, marginBottom:4 },
...
const s = StyleSheet.create({
  ...
  scansBadge:    { backgroundColor:C.greenBg, borderRadius:100, paddingHorizontal:8, paddingVertical:3, borderWidth:1, borderColor:C.greenBorder },
  ...
  // Live
  liveBar:       { backgroundColor:C.surface, borderWidth:1, borderColor:"#ff6b6b30", borderRadius:13, padding:12, flexDirection:"row", alignItems:"center", gap:8, marginBottom:14 },
  liveDot:       { width:8, height:8, borderRadius:4, backgroundColor:C.red, flexShrink:0 },
  liveLbl:       { color:C.red, fontSize:8, fontWeight:"900", letterSpacing:1.5, flexShrink:0 },
  liveTxt:       { color:C.text2, fontSize:12, flex:1, lineHeight:17 },
  liveTime:      { color:C.text4, fontSize:10, flexShrink:0 },
  // Stats
  ...
  csBadge:       { borderWidth:1, borderRadius:100, paddingHorizontal:8, paddingVertical:3, marginLeft:8, flexShrink:0 },
  ...
  verdict:       { borderRadius:8, paddingHorizontal:8, paddingVertical:4, minWidth:48, alignItems:"center", flexShrink:0 },
