...
const PLANS = [
    ...
    priceId_annual:"price_1Tan96Da11MSShNknDTWp54n" },
  {
    ...
    priceId_annual:null },
  {
    id:"business", tierLabel:"BUSINESS", label:"💼 Business", price:"$79", sub:"/month · intro rate", color:"#ff8c42",
    annualPrice:"$597", annualSub:"/year · intro rate", annualSavings:"Save $351",
    regularPrice:"$149/mo",
    ...
    priceId_monthly:"price_1TamYDDa11MSShNkzgDEtA0F",
...
export default function UpgradeScreen({ token, plan, onNavigate, onBack }: Props) {
  ...
  async function subscribe(priceId: string, planId: string) {
    if (!priceId) return;
    if (planId === "business") {
      require("react-native").Linking.openURL("mailto:team@getvaluiq.com?subject=ValuIQ%20Business%20Waitlist");
      return;
    }
    setLoading(planId);
    try {
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.faqSection}>
          ...
          {[
            ...
            { q:"When does Business launch?", a:"Coming Q3 2026. Join the waitlist to lock in the $79/month founding rate — it goes to $149/month after the first 50 subscribers." },
...
const s = StyleSheet.create({
  ...
  backTxt:         { color:C.text3, fontSize:14, fontWeight:"600" as any },
  ...
  toggleBtn:       { flex:1, paddingVertical:11, borderRadius:10, alignItems:"center" as any, justifyContent:"center" as any, flexDirection:"row" as any, gap:4 },
  ...
  tierLabelRow:    { flexDirection:"row" as any, alignItems:"center", justifyContent:"space-between", paddingHorizontal:16, paddingVertical:8, marginBottom:0, borderTopLeftRadius:16, borderTopRightRadius:16 },
  tierLabel:       { fontSize:10, fontWeight:"900" as any, letterSpacing:2 },
  tierStatusBadge: { fontSize:9, fontWeight:"900" as any, color:"#000", paddingHorizontal:10, paddingVertical:3, borderRadius:100, letterSpacing:0.5 },
  ...
  savingsBadge:    { alignSelf:"flex-start" as any, borderWidth:1, borderRadius:100, paddingHorizontal:10, paddingVertical:3, marginTop:6 },
  ...
  // CTA,
  cta:             { marginHorizontal:16, marginBottom:16, borderRadius:12, paddingVertical:14, alignItems:"center" as any },
