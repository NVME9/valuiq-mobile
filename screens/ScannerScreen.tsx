        ...
        <ScrollView contentContainerStyle={{padding:16,paddingBottom:60}} showsVerticalScrollIndicator={false}>
          ...
          {hasNoData && (
            <View style={s.noDataCard}>
              ...
              <TouchableOpacity style={[s.navBtn,{alignSelf:"center",paddingHorizontal:24,paddingVertical:12}]} onPress={() => setStep("camera")}>
          ...
          {!hasNoData && (
            <>
              ...
              {/* Battle this item */}
              <TouchableOpacity style={s.battleBtn} onPress={()=>onNavigate("price-battle")} activeOpacity={0.85}>
                  ...
                  {result.decision==="BUY" && photos[0] && (
                    <View style={s.shareCard}>
                      ...
                      <View style={s.shareCardBody}>
                        <View style={s.shareCardBadge}><Text style={s.shareCardBadgeTxt}>✅ BUY IT</Text></View>
                        <Text style={s.shareCardItem} numberOfLines={1}>{result.itemName||"Item"}</Text>
                        <View style={s.shareCardRow}>
                          <View style={s.shareCardStat}>
                            <Text style={s.shareStatVal}>+${Math.round(result.netProfit||0)}</Text>
                            <Text style={s.shareStatLbl}>PROFIT</Text>
                          </View>
                          <View style={s.shareCardStat}>
                        ...
                        <Text style={s.shareCardFooter}>Found with ValuIQ • getvaluiq.com</Text>
                      </View>
                    </View>
                  )}
                  <ShareButton
...
const s = StyleSheet.create({
  ...
  // Camera,
  camTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 16, paddingTop: 12, paddingBottom: 8 },
  ...
  greenBtn:       { backgroundColor: C.green, borderRadius: 14, paddingVertical: 14, paddingHorizontal: 32, alignItems: "center" as any, alignSelf: "center" as any },
  ...
  shareCardBadge:   { backgroundColor:C.green, borderRadius:100, paddingHorizontal:12, paddingVertical:4, alignSelf:"flex-start" as any, marginBottom:8 },
